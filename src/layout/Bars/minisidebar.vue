<template>
  <div class="additional-classes">
    ...
    >
      ...
      <div
        v-else
        class="mx-auto flex h-10 w-10 items-center justify-center rounded-full overflow-hidden"
      >
        <img
      ...
      <span
        class="-bottom-0.5 left-7 absolute w-2.5 h-2.5 bg-green-400 border border-primary rounded-full"
      ></span>
    </div>
    <div
