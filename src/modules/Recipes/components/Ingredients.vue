...
<template>
            ...
            <button class="btn-primary" uk-toggle="target: #ingredient_modal">
                {{ t("Add") }}
            </button>
        </div>
          <EasyDataTable theme-color="#7367f0" hide-footer :headers="ingredients" :items="[]">
          ...
          <TwPagination :total="2" class="mt-10 tw-pagination" :current="1" :per-page="10"
