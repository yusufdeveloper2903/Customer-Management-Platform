...
export default defineStore("knowledgeBase", {
    state: () => {
        return {
            ...
            faqsList: {
                results: [] as FaqsMessage[]
            } as Results<FaqsMessage>,
            productCategories: {
                results: [] as IProductCategories[]
            } as Results<IProductCategories>,
    ...
    actions: {
        ...
        async getFaqs(params?) {
            const {data} = await $axios.get('/knowledge_base/faq/', {params})
            this.faqsList = data
        },
        //CREATE REQUEST
        createFaqs(data: any) {
            return $axios.post("/knowledge_base/faq/", data);
        },
        ...
        //DELETE REQUEST
        deleteFaqs(id: number | null) {
            return $axios.delete(`/knowledge_base/faq/${id}/`);
        },
        ...
        createProductCategory(data: any) {
            return $axios.post("/products/product_category/", data);
        },

        updateProductCategory(data: any) {
            return $axios.patch(`/products/product_category/${data.id}/`, data);
        },

        deleteProductCategory(id: any) {
            return $axios.delete(`/products/product_category/${id}`);
        },
    },
});
