...
<template>
  <div id="intro" class="uk-flex-top" uk-modal>
    <div
        ...
        <Tabs>
          <Tab title="Uz">
            <form>
              ...
              <label class="mt-4 block" for="descriptionUz">Tavsif</label>
              <input
                id="descriptionUz"
                type="text"
                class="form-input"
              ...
              <label class="mt-4 block" for="fileUz">Fayl</label>
          ...
          <Tab title="Ru">
            <form>
              ...
              <label class="mt-4 block" for="descriptionRu">Описание</label>
              <input
                id="descriptionRu"
                type="text"
                class="form-input"
