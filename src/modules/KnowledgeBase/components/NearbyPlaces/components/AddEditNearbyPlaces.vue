            ...
            <div class="w-1/2">
              ...
              <div class="w-full mt-4">
                ...
                <v-select :options="store.regionsList.results" v-model="location.region"
                  :getOptionLabel="(name: any) => name['name_' + $i18n.locale]" :reduce="(name: any) => name.id" >
              ...
              <div class="w-full mt-4">
                ...
                <VueDatePicker format="dd-MM-yyyy" auto-apply v-model="openTime" time-picker></VueDatePicker>
              </div>
              <div class="w-full mt-4">
                <label class="relative"> {{ $t('Close hour') }} </label>
                <VueDatePicker format="dd-MM-yyyy" auto-apply v-model="closeTime" time-picker></VueDatePicker>
              ...
              <div class="relative">
                <div class="w-full">
                  <div class="w-full uk-margin mb-5">
                    ...
                    <div class="uk-form-controls">
                      <!--                  @input="findLocation"-->
                      <input class="form-input" id="form-stacked-text" type="text" v-model="search" @input="findLocation">
                    </div>
                  </div>
                </div>

                <div v-if="features.length"
                  class="absolute top-[66px] w-full left-0 bg-white max-h-[300px] overflow-y-auto" style="z-index: 2000">
