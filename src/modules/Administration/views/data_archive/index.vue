...
const refresh = async () => {
  ...
  await administrationStorage.FETCH_BACKUP_MEDIA_LIST(params.value).then(response => {
...
const createBackup = async () => {
  ...
  await administrationStorage.CREATE_BACKUP_MEDIA().then( async response => {
...
const deleteBackup = async () => {
  ...
  await administrationStorage.DELETE_BACKUP_MEDIA(deletingID.value).then( async response => {
...
const onInput = async (event) => {
  params.value.currentPage = event
    ...
    <div class="rounded bg-white p-5 pb-10 dark:bg-darkLayoutStorm w-full">
        ...
        <div class="flex items-start gap-10 w-full">
          <div class="w-full">
            ...
            <EasyDataTable
              v-if="administrationStorage.back_up_media_list && administrationStorage.back_up_media_list.results"
              theme-color="#7367f0"
              show-index
              buttons-pagination
              :headers="headers"
