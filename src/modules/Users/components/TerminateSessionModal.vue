...
<template>
  <div id="terminate-session-modal" class="uk-flex-top" uk-modal>
    <div
    ...
    >
      ...
      <div class="uk-modal-body">
        <p>{{ $t("are_you_really_terminate_session") }}</p>
      </div>
      <div
        class="uk-modal-footer flex justify-end gap-3 uk-text-right px-5 py-3 bg-white"
      >
        <button uk-toggle="target: #terminate-session-modal" class="btn-secondary">
          {{ $t("Cancel") }}
        </button>
        <button
